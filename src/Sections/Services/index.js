...
const Services = () => {
  ...
  return (
    <ServiceSection id="services">
      <Background ref={ref}>
        <Title className="title">Timeline</Title>
        <Line id="line" />
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="22nd Jan"
          title={<h1>Event begins</h1>}
          subText={<h5>Let the hacking begin!!</h5>}
        />
        <OBJ>
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="26th Jan"
          title={<h1>End of Event</h1>}
          subText={<h5>Let all your ideas illuminate reality...</h5>}
        />
        <OBJ>
      ...
      <Content>
        <TextBlock
          topic="31st Jan"
          title={<h1>Results Announced</h1>}
          subText={<h5>Lorem ipsum dolor sit amet, consectetur</h5>}
        />
        <OBJ>
